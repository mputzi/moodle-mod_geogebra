...
$string['urlggb_help'] = 'URL del fichero deployggb.js donde se encuentra la distribución del Geogebra. Habitualmente se encuentra en geogebra.org. Puede ser un fichero local.';
